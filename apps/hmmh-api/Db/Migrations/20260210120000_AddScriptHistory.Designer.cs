...
namespace Hmmh.Api.Db.Migrations
{
    ...
    [Migration("20260210120000_AddScriptHistory")]
    partial class AddScriptHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hmmh.Api.Db.Models.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Hmmh.Api.Db.Models.CalorieEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Hmmh.Api.Db.Models.ScriptHistory", b =>
                {
            ...
            modelBuilder.Entity("Hmmh.Api.Db.Models.WeightEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Hmmh.Api.Db.Models.CalorieEntry", b =>
                {
                    b.HasOne("Hmmh.Api.Db.Models.ApplicationUser", "User")
                        .WithMany()
